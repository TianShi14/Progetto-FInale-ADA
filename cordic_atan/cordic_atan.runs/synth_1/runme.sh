...
HD_PWD='C:/Users/aless/OneDrive/Documenti/GitHub/Progetto-FInale-ADA/cordic_atan/cordic_atan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log atan.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source atan.tcl
