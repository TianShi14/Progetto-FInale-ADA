...
HD_PWD='C:/Users/Angelo Nutu/Documents/Vivado/Final Project/adxl345/adxl345.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log accelerometer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source accelerometer.tcl -notrace
