...
synth_design -top atan -part xc7z020clg484-1
...
write_checkpoint -force -noxdef atan.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file atan_utilization_synth.rpt -pb atan_utilization_synth.pb"
