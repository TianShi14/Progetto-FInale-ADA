...
HD_PWD='C:/Users/Angelo Nutu/Documents/Vivado/Final Project/adxl345/adxl345.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accelerometer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accelerometer.tcl
